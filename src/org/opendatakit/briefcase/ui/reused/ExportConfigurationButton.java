...
public class ExportConfigurationButton {
  ...
  public static int compare(JButton a, JButton b) {
    boolean aConfigured = a.getForeground().equals(NO_CONF_OVERRIDE_COLOR);
    boolean bConfigured = b.getForeground().equals(NO_CONF_OVERRIDE_COLOR);
